...
Status: DISPATCHED. Task 1 landed, commit stamped below, 2026-09-09; task 2 is planned next.
...
- 0.1.3-1 — the opening: her hit points, the guard squad, the opening scrap, faster welding. LANDED, commit stamped below. → `task-0.1.3-1-the-opening.md`
- 0.1.3-2 — the field: no town, the ship as the objective, placement room, the gouge, the felled trees. Planned after task 1 lands.
