...
- 0.1.4-1 — coldsnap's page whole: the 36 files, the shell, the page maker, the build into `docs/coldsnap/`, a gate over it. LANDED, commit stamped below. → `task-0.1.4-1-coldsnaps-page-whole.md`
