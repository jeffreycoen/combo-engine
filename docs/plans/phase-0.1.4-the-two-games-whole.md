...
Status: DISPATCHED. Task 1 landed, commit `41d7e8c`, 2026-09-09; task 2 is planned next.
...
- 0.1.4-1 — coldsnap's page whole: the 36 files, the shell, the page maker, the build into `docs/coldsnap/`, a gate over it. LANDED, commit `41d7e8c`. → `task-0.1.4-1-coldsnaps-page-whole.md`
