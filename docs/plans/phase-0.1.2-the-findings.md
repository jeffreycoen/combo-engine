...
- 0.1.2-2 — she steps aside: her stand off the wreck at coldsnap's room distance; anyone of hers inside it moved clear by coldsnap's own rule before the walker is built. DISPATCHED. → `task-0.1.2-2-she-steps-aside.md`
