...
Status: LANDED, commit `6a368bb`, 2026-09-09. Five tasks landed; the ark's gate 49 PASS / 0 FAIL; the parts build 50 gates, every verdict ok.
...
- 0.1.2-5 — space as deadweight draws it: the drawing from the demo's lines 849 to 1461 in a space screen file of its own. LANDED, commit `6a368bb`. → `task-0.1.2-5-space-as-deadweight.md`
