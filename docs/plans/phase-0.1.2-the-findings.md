...
Status: DISPATCHED. Task 4 landed, commit stamped below, 2026-09-09; task 5 is planned next.
...
- 0.1.2-4 — the ship's look on the ground: deadweight's module drawing as solid shapes in coldsnap's scene, through one listed door. LANDED, commit stamped below. → `task-0.1.2-4-the-ships-look.md`
