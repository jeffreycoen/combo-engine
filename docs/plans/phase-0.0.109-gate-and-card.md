...
Every number below is the run's output (rolled seeds 905414099, 25050496).

- `node scripts/gravitys-ark-test.mjs` prints a seeds line, 17 PASS lines in the worktree, then `gravitys-ark-test: 17 PASS / 0 FAIL`, then `gravitys-ark-test PASS`, exit 0; 32 at the landing.
