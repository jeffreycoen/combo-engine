...
Status: SERVED. Task 0.1.1-1's first run stopped at its gate on 2026-09-09; the amended task is served for review, the applied files standing.
...
- 0.1.1-1 — the ground boots: coldsnap's war on the ark's page, guns by its build law, the one purse, sound, TAKE OFF. SERVED. → `task-0.1.1-1-the-ground-boots.md`
